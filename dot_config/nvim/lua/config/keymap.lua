...
-- Utility functions to quickly map keys to a given mode
-- nmap -> Normal mode
-- vmap -> Visual mode
-- imap -> Insert mode
-- cmap -> Command mode
...
-- map shift+enter to send cell, then go to next quarto block wrapped in ```{python} ```
-- nmap("<S-CR>", send_cell)
imap("<13;2u>", send_cell)
nmap("<13;2u>", send_cell)
